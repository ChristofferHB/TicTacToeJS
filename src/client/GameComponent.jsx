...
export class GameComponent extends React.Component {
    ...
    playerMoveCallback(data) {
        this.setBoxData(data.playerMove);
    }
        ...
        if (!boxData[boxNumber]) {
            switch (boxNumber) {
                case 0:
                    ...
                    SocketConnection.emitPlayerMove(this.props.gameCode, this.props.username, 0);
                ...
                case 1:
                    ...
                    SocketConnection.emitPlayerMove(this.props.gameCode, this.props.username, 1);
                ...
                case 2:
                    ...
                    SocketConnection.emitPlayerMove(this.props.gameCode, this.props.username, 2);
                ...
                case 3:
                    ...
                    SocketConnection.emitPlayerMove(this.props.gameCode, this.props.username, 3);
                ...
                case 4:
                    ...
                    SocketConnection.emitPlayerMove(this.props.gameCode, this.props.username, 4);
                ...
                case 5:
                    ...
                    SocketConnection.emitPlayerMove(this.props.gameCode, this.props.username, 5);
                ...
                case 6:
                    ...
                    SocketConnection.emitPlayerMove(this.props.gameCode, this.props.username, 6);
                ...
                case 7:
                    ...
                    SocketConnection.emitPlayerMove(this.props.gameCode, this.props.username, 7);
                ...
                case 8:
                    ...
                    SocketConnection.emitPlayerMove(this.props.gameCode, this.props.username, 8);
